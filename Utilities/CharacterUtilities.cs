...
namespace Average.Shared.Utilities
{
    public class PedOrigin
    {
    ...
    public class PedOverlay
    {
        ...
        public PedOverlay(string name, uint id, uint albedo, uint normal, uint material)
        {
            Name = name;
            Id = id;
            Albedo = albedo;
    ...
    {
        public static List<PedOrigin> Origins { get; } = new List<PedOrigin>
        {
            new PedOrigin()
            {
                Gender = Gender.Male,
                Heads = new List<string> { "A0BE4A7B", "1E78F6D", "27A4DC22", "5E9A394D", "7BE9E352", "7D7AA347", "839997EF", "84F3E485", "876B1FAE" },
                Bodies = new List<string> { "206061DB", "16E292A1", "206061DB", "4AEEDD87", "4BD8F4A1", "BA59624D", "F6496128" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "3825D527", "5A929214", "82F14D87", "99E82863", "DF522C3A" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "465F719A", "6D582255", "8CC97681", "B0D24F3F" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "34C3B131", "5C1686B", "8C9686C8", "BF787383" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "4824ED39", "3B6F503", "5EA984F8", "B4485D23", "6BB6BC48" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "69B6305B", "BA09D8ED", "C8EA5978", "CD7F8895" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "489AFE52", "64181923", "8DCF7A49", "928DAD43", "B1D3B3A", "D878696D" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "8002D0F8", "6C25B6F6", "8223BCC5", "2BE27CC4", "C1CF0BC1" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "2C4FE0C5", "3708268F", "7145337D", "79D35251", "B2850A03" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "5B4E1547", "58D8EA30", "87363366", "D0C5A9AE", "DC86C81" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "80DB09DE", "93925FA2", "94778799", "56617DB6", "E36416C" },
            ...
            new PedOrigin()
            {
                ...
                Bodies = new List<string> { "35A7C9FB", "1B088705", "A1AEFBDB", "E28C4D3B", "C05A25AD" },
                Legs = new List<string> { "27B700C2", "4BA188D", "AAD70276", "EDE17D5F", "F4F5A364" },
                HeadTexture = "mp_head_fr1_sc04_c0_000_ab"
            }
        };
        public static List<PedOverlay> FaceOverlays = new List<PedOverlay>
        {
        ...
        public static List<string> FaceOverlayLayers = new List<string>
        {
            "eyebrows",
            "scars",
            "eyeliners",
